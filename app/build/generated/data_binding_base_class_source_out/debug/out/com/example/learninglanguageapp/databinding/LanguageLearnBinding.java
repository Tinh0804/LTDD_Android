...
public final class LanguageLearnBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static LanguageLearnBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LanguageLearnBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.language_learn, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LanguageLearnBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LanguageLearnBinding((ConstraintLayout) rootView, btnBack, btnContinue,
          listViewLearn, progressBar, tvProgress, tvTitle);
    }
